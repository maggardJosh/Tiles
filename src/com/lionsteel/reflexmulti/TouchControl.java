...
public class TouchControl extends Entity implements ReflexConstants
{
	...
	public TouchControl(final Runnable action, final Runnable resetAction)
	{
		...
		readyImage = new Sprite(0, 0, SharedResources.getInstance().readyRegion, ReflexActivity.getInstance().getVertexBufferObjectManager());
	...
	private void resetButton()
	{
		...
		readyImage.registerEntityModifier(new AlphaModifier(TOUCH_CONTROL_RESET, readyImage.getAlpha(), 0.0f));
	}
}
